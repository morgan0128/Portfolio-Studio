...
[ApiController]
[Route("api/Album")]
public sealed class AlbumControllerOld(IAlbumRepository albumRepository, IUploadPhotoService uploadPhotoService)
    : ControllerBase
{
    // [HttpGet("all")]
    ...
    // {
    //     var request = await albumRepository.ToggleDisplaysYearContentCreated(id, photoId);
    //     return request switch
    //     {
    //         true => Ok(),
    //         false => Problem()
